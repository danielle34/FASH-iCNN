"""
Training loop for copalette_clothing_constrained.

Single-image classifier with mixed precision, differential LR, label
smoothing, early stopping, and checkpoint resume per condition.
"""

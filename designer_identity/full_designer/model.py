"""
Dual-stream face + clothing model for color prediction.
...
parameter count stays appropriate.
...
class DualCropModel(nn.Module):
    """Face + clothing dual-stream classifier with optional ablation."""
